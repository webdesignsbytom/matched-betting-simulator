    ...
    <section className="outline outline-4 outline-black rounded grid bg-[#008080] my-4">
      <article className="p-2 pb-10">
        <div className="grid grid-flow-col gap-4 w-fit mb-2">
          <h3 className="font-semibold">Stage Four: </h3>
        ...
        <div className="stage__info__container">
          ...
          <span>
            Select and sport from the list and find an event to bet on.
          </span>
          <span>
            This is for your Qualifying bet. Where you cancel out money one or
            lost with your bets to come as close to even as possible. The best
            way to do this is with low odds and very close to each other
          </span>
          <span>
            Find the same event and bet option with the closest odds. i.e
            bookie:2 exchange: 2.1
          </span>
          <span>
